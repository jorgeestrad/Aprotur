    ...
    public partial class InitialDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FormatoDocumento", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TipoFuenteBibliografica", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReferenciaAPA = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    ...
                    Enlace = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Documento_FormatoDocumento_FormatoDocumentoId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Documento_TipoFuenteBibliografica_TipoFuenteBibliograficaId",
                        column: x => x.TipoFuenteBibliograficaId,
                        principalSchema: "Proyectos",
                        principalTable: "TipoFuenteBibliografica",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RespuestaComentario", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RespuestaComentario_Comentario_ComentarioId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Documento_FormatoDocumentoId",
                schema: "Proyectos",
                table: "Documento",
                column: "FormatoDocumentoId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Documento_TipoFuenteBibliograficaId",
                schema: "Proyectos",
                table: "Documento",
                column: "TipoFuenteBibliograficaId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FormatoDocumento_Nombre",
                schema: "Proyectos",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RespuestaComentario_ComentarioId",
                schema: "Proyectos",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TipoFuenteBibliografica_Nombre",
                schema: "Proyectos",
                table: "TipoFuenteBibliografica",
                column: "Nombre",
                unique: true);
